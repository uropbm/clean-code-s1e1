...
var incompleteTaskHolder = document.getElementById("complete");//ul of #incompleteTasks
...
var createNewTaskElement = function(taskString){
    ...
    //input (checkbox)
    var checkBox = document.createElement("input");//checkbx label

    var label = document.createElement("label");//label input (text)

    var editInput = document.createElement("input");//text button.edit
